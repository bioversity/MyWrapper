...
try
{
	...
	echo( "[$result] <pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<i>$result = CAttribute::ManageTypedOffset( $test, \'ManageTypedOffset\', \'TYPE\', \'DATA\', array( \'type1\', \'type2\' ), array( \'data1\', \'$data2\' ), TRUE );</i><br>' );
	$result = CAttribute::ManageTypedOffset( $test, 'ManageTypedOffset', 'TYPE', 'DATA', array( 'type1', 'type2' ), array( 'data1', '$data2' ), TRUE );
	echo( "Result <pre>" ); print_r( $result ); echo( '</pre>' );
	echo( "Object <pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<i>$result = CAttribute::ManageTypedOffset( $test, \'ManageTypedOffset\', \'TYPE\', \'DATA\', array( \'type1\', \'type2\' ), array( FALSE, FALSE ), TRUE );</i><br>' );
	$result = CAttribute::ManageTypedOffset( $test, 'ManageTypedOffset', 'TYPE', 'DATA', array( 'type1', 'type2' ), array( FALSE, FALSE ), TRUE );
	echo( "Result <pre>" ); print_r( $result ); echo( '</pre>' );
	echo( "Object <pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
