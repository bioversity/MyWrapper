...
try
{
	...
	echo( '<i>$object1[ kOFFSET_ID ] = \'ENTITY1\';</i><br>' );
	$object1[ kOFFSET_ID ] = 'ENTITY1';
	...
	echo( '<i>$object1[ kOFFSET_ID ] = \'ENTITY2\';</i><br>' );
	$object1[ kOFFSET_ID ] = 'ENTITY2';
	...
	echo( '<i>$object1[ kOFFSET_ID ] = \'ENTITY3\';</i><br>' );
	$object1[ kOFFSET_ID ] = 'ENTITY3';
	...
	echo( '<i>$object3->Relate( $object3[ kOFFSET_ID ], FALSE, TRUE );</i><br>' );
	$object3->Relate( $object3[ kOFFSET_ID ], FALSE, TRUE );
