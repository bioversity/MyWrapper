...
try
{
	...
	echo( '<i>$object1[ kTAG_LID ] = \'ENTITY1\';</i><br>' );
	$object1[ kTAG_LID ] = 'ENTITY1';
	...
	echo( '<i>$object1[ kTAG_LID ] = \'ENTITY2\';</i><br>' );
	$object1[ kTAG_LID ] = 'ENTITY2';
	...
	echo( '<i>$object1[ kTAG_LID ] = \'ENTITY3\';</i><br>' );
	$object1[ kTAG_LID ] = 'ENTITY3';
	...
	echo( '<i>$object3->Relate( $object3[ kTAG_LID ], FALSE, TRUE );</i><br>' );
	$object3->Relate( $object3[ kTAG_LID ], FALSE, TRUE );
