...
try
{
	...
	$term1->Code( 'NS' );
	echo( '<i>$term1->Kind( kOFFSET_TERM_NAMESPACE, TRUE );</i><br>' );
	$term1->Kind( kOFFSET_TERM_NAMESPACE, TRUE );
	...
	$term2->Code( 'TERM2' );
	echo( '<i>$term2->Kind( kOFFSET_TERM, TRUE );</i><br>' );
	$term2->Kind( kOFFSET_TERM, TRUE );
