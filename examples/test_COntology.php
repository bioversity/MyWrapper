...
try
{
	...
	try
	{
		...
		echo( '<i>$test = new COntology();</i><br>' );
		$test = new COntology();
	...
	try
	{
		...
		echo( '<i>$test = new COntology( $content ) );</i><br>' );
		$test = new COntology( $content );
		echo( '<pre>' ); print_r( $test ); echo( '</pre>' );
	}
	catch( Exception $error )
	{
	...
	echo( '<i>From an ontology</i><br>' );
	echo( '<i>$test = new COntology( $container, $test ) );</i><br>' );
	$test = new COntology( $container, $test );
	echo( '<pre>' ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
	...
	echo( '<i>$test = new COntology( $container );</i><br>' );
	$test = new COntology( $container );
	...
	echo( '<i>$test = new COntology( $container, -1 );</i><br>' );
	$test = new COntology( $container, -1 );
	echo( "<pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
	
	echo( '<i>Retrieve</i><br>' );
	echo( '<i>$test = new COntology( $container, $id );</i><br>' );
	$test = new COntology( $container, $id );
	echo( "$id:<pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
	
	echo( '<i>Retrieve with node</i><br>' );
	echo( '<i>$test = new COntology( $container, $test->Node() );</i><br>' );
	$test = new COntology( $container, $test->Node() );
	echo( "$id:<pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
