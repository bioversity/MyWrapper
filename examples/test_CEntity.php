...
try
{
	...
	echo( '<i>$entity1[ kTAG_LID ] = new CDataTypeBinary( md5( \'MILKO\', TRUE ) );</i><br>' );
	$entity1[ kTAG_LID ] = new CDataTypeBinary( md5( 'MILKO', TRUE ) );
	...
	echo( '<i>$entity2[ kTAG_LID ] = new CDataTypeMongoId();</i><br>' );
	$entity2[ kTAG_LID ] = new CDataTypeMongoId();
	...
	echo( '<i>$test = new CEntity( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
	$test = new CEntity( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );
	echo( "Identifier:<pre>" ); print_r( $entity1[ kTAG_LID ] ); echo( '</pre>' );
	echo( "Object:<pre>" ); print_r( $test ); echo( '</pre>' );
	echo( '<hr>' );
	echo( '<hr>' );
	...
	echo( '<i>$entity1[ kTAG_LID ];</i><br>' );
	echo( '<pre>' ); print_r( $entity1[ kTAG_LID ] ); echo( '</pre>' );
	echo( '<i>$valid = CEntity::ValidObject( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
	$valid = CEntity::ValidObject( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );
	echo( '<pre>' ); print_r( $valid ); echo( '</pre>' );
	echo( '<hr>' );

	echo( '<i>$entity2[ kTAG_LID ];</i><br>' );
	echo( '<pre>' ); print_r( $entity2[ kTAG_LID ] ); echo( '</pre>' );
	echo( '<i>$valid = CEntity::ValidObject( $collection, $entity2[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
	$valid = CEntity::ValidObject( $collection, $entity2[ kTAG_LID ], kFLAG_STATE_ENCODED );
	echo( '<pre>' ); print_r( $valid ); echo( '</pre>' );
	echo( '<hr>' );

	echo( '<i>$entity3[ kTAG_LID ];</i><br>' );
	echo( '<pre>' ); print_r( $entity3[ kTAG_LID ] ); echo( '</pre>' );
	echo( '<i>$valid = CEntity::ValidObject( $collection, $entity3[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
	$valid = CEntity::ValidObject( $collection, $entity3[ kTAG_LID ], kFLAG_STATE_ENCODED );
	echo( '<pre>' ); print_r( $valid ); echo( '</pre>' );
	echo( '<hr>' );
	echo( '<hr>' );
	...
	try
	{
		echo( '<i>$entity3->Valid( $entity1[ kTAG_LID ] );</i><br>' );
		$entity3->Valid( $entity1[ kTAG_LID ] );
	...
	try
	{
		echo( '<i>$collection->Delete( $entity2[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
		$collection->Delete( $entity2[ kTAG_LID ], kFLAG_STATE_ENCODED );
		echo( '<i>$valid = CEntity::ValidObject( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );</i><br>' );
		$valid = CEntity::ValidObject( $collection, $entity1[ kTAG_LID ], kFLAG_STATE_ENCODED );
		echo( '<pre>' ); print_r( $valid ); echo( '</pre>' );
	}
