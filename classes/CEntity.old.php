 ...
 *
 * <ul>
 *	<li><i>{@link kTAG_REF kTAG_REF}</i>: This offset represents the entity parents or
 ...
 *======================================================================================*/
	 ...
	 *
	 * This method can be used to manage the entity {@link kTAG_REF parents}, you can
 ...
 *======================================================================================*/
	...
	protected function _PrepareStore( &$theContainer, &$theIdentifier )
	{
		...
		if( $this->offsetExists( kTAG_REF ) )
		{
			...
			// Iterate parents.
			//
			$parents = $this->offsetGet( kTAG_REF );
