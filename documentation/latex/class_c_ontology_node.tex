...
We also copy the \hyperlink{}{kind}, \hyperlink{}{domain}, \hyperlink{}{category} and \hyperlink{class_c_ontology_term_afd46ef8241b696e99cf7b5e1334914b7}{type} elements, if not yet present, from the \hyperlink{class_c_ontology_node_a2f294a9c93079f58190cedbdd0c09068}{term} to the current node.
...
\hypertarget{class_c_ontology_node_af7c5151101b786f49722f7c6576fde70}{\index{C\-Ontology\-Node@{C\-Ontology\-Node}!Cardinality@{Cardinality}}
\index{Cardinality@{Cardinality}!COntologyNode@{C\-Ontology\-Node}}
\subsubsection[{Cardinality}]{\setlength{\rightskip}{0pt plus 5cm}C\-Ontology\-Node\-::\-Cardinality (
\begin{DoxyParamCaption}
\item[{}]{\$the\-Value = {\ttfamily NULL}, }
\item[{}]{\$get\-Old = {\ttfamily FALSE}}
\end{DoxyParamCaption}
)}}\label{class_c_ontology_node_af7c5151101b786f49722f7c6576fde70}
...
This method can be used to manage the node \hyperlink{}{categories}, in general it reflects the \hyperlink{class_c_ontology_node_a2f294a9c93079f58190cedbdd0c09068}{term} \hyperlink{}{categories}.
...
\begin{DoxyParams}[1]{Parameters}
mixed & {\em \$the\-Value} & Term or index. \\
\hline
mixed & {\em \$the\-Operation} & Operation. \\
\hline
boolean & {\em \$get\-Old} & T\-R\-U\-E get old value.\\
...
This method can be used to manage the node \hyperlink{}{domains}, in general it reflects the \hyperlink{class_c_ontology_node_a2f294a9c93079f58190cedbdd0c09068}{term} \hyperlink{}{domains}.
...
This method can be used to manage the node \hyperlink{}{kinds}, in general it reflects the \hyperlink{class_c_ontology_node_a2f294a9c93079f58190cedbdd0c09068}{term} \hyperlink{}{kinds}.
...
\hypertarget{class_c_ontology_node_aa10250322a181c5085058d91da129f37}{\index{C\-Ontology\-Node@{C\-Ontology\-Node}!Relate\-To@{Relate\-To}}
...
\item[{}]{\$do\-Duplicate = {\ttfamily FALSE}}
\end{DoxyParamCaption}
)}}\label{class_c_ontology_node_aa10250322a181c5085058d91da129f37}
Create a graph edge.

This method can be used to create a graph edge or relation between the current node and an object node using a predicate node. This method consideres the triplet subject node/predicate term/object node as the relationship identifier when considering duplicate relationships. For that reason the subject and object terms of the relationship must relate to \hyperlink{class_c_persistent_object_a6520a7bcecf3f39fd61ec6d08f736e77}{committed} nodes.
...
\hline
boolean & {\em \$do\-Duplicate} & T\-R\-U\-E means duplicate relationship.\\
\hline
\end{DoxyParams}
public \begin{DoxyReturn}{Returns}
