...
Reimplemented in \hyperlink{class_c_ontology_tag_afe9d06131f9b005732238ed0d8e8c7be}{C\-Ontology\-Tag}.
...
Reimplemented in \hyperlink{class_c_dataset_a0b2ca2d83f0be648b92f251fad1f0aa8}{C\-Dataset}, \hyperlink{class_c_ontology_term_object_aab0069df9aae1a8480ea0cdd933a58f1}{C\-Ontology\-Term\-Object}, \hyperlink{class_c_ontology_tag_aae0a9faff91a7c06007e65b8358380aa}{C\-Ontology\-Tag}, and \hyperlink{class_c_coded_unit_object_a990c19b8bf98d2784da81e3a3121ce56}{C\-Coded\-Unit\-Object}.
...
We also handle queries provided in the identifier, in this case we only check whether the container is supported.
...
This method can be used to format an identifier provided as a string, it will be used by the \hyperlink{class_c_persistent_unit_object_ad1ca0920cf0df3c24351402f9afbf34b}{\-\_\-id} method to format the result of the \hyperlink{class_c_persistent_unit_object_a5166fdce0b1be6a3e4889f20c5f1c2dd}{\-\_\-index} method.

All derived classes will call this method to format the object \hyperlink{}{I\-D}, so you should overload this method in classes where the current behaviour is not desirable.
...
Reimplemented in \hyperlink{class_c_f_a_o_institute_ad9004a3928ad07bdac2988f48c5a8cdd}{C\-F\-A\-O\-Institute}, \hyperlink{class_c_ontology_tag_ab14f0553891595cb3ea1d98016c01078}{C\-Ontology\-Tag}, \hyperlink{class_c_user_ada20d1f74260a4a5f67453bc9b4f3990}{C\-User}, and \hyperlink{class_c_institute_a7a6915d35bc47272faabe8111574dddc}{C\-Institute}.
...
\end{DoxySeeAlso}
\hypertarget{class_c_persistent_unit_object_ad9c886156b37fa09552de223b1efddd6}{\index{C\-Persistent\-Unit\-Object@{C\-Persistent\-Unit\-Object}!Normalise\-Related\-Predicate@{Normalise\-Related\-Predicate}}
\index{Normalise\-Related\-Predicate@{Normalise\-Related\-Predicate}!CPersistentUnitObject@{C\-Persistent\-Unit\-Object}}
\subsubsection[{Normalise\-Related\-Predicate}]{\setlength{\rightskip}{0pt plus 5cm}static C\-Persistent\-Unit\-Object\-::\-Normalise\-Related\-Predicate (
\begin{DoxyParamCaption}
\item[{}]{\$the\-Value}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_c_persistent_unit_object_ad9c886156b37fa09552de223b1efddd6}
...
This method will extract a string identifier from the provided parameter, it is used to get a value to be used when matching objects derived from this class.

The expected parameter is supposed to be either an object reference or its identifier, this method makes no assumption on the state of the provided object, its duty is to spit out a string that represents the object \hyperlink{}{identifier}.
