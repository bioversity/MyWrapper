...
In this class we perform different actions depending on which operation was requested\-:


\begin{DoxyItemize}
\item {\itshape \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-G\-E\-T\-\_\-\-T\-E\-R\-M\-S}}\-: Each provided identifier that is not an array will be hashed and the resulting array will be used to generate a \hyperlink{class_c_query_statement_a5e1a291d73a20b4f88c019d1863a4c81}{member} \hyperlink{}{query}. 
\item {\itshape \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-G\-E\-T\-\_\-\-N\-O\-D\-E\-S} and \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-G\-E\-T\-\_\-\-E\-D\-G\-E\-S}}\-: The same actions as the previous case, except that the resulting query will be treated as a list of numbers. 
\end{DoxyItemize}
...
\end{DoxySeeAlso}
\hypertarget{class_c_warehouse_wrapper_aa88d34fb335682cde5e4574edc7d8017}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Format\-Query@{\-\_\-\-Format\-Query}}
\index{\-\_\-\-Format\-Query@{\-\_\-\-Format\-Query}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Format\-Query}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Format\-Query (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_aa88d34fb335682cde5e4574edc7d8017}
Format query.

This method will format the request query.

In this class we enforce the root selector for the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-G\-E\-T\-\_\-\-R\-O\-O\-T\-S} service.

protected 

Reimplemented from \hyperlink{class_c_mongo_data_wrapper_a807db77c3c4f7708e86873a0447b83ff}{C\-Mongo\-Data\-Wrapper}.
...
This method will process the query provided in the \hyperlink{}{k\-A\-P\-I\-\_\-\-D\-A\-T\-A\-\_\-\-Q\-U\-E\-R\-Y} parameter and return a result structured as follows\-:
...
\begin{DoxyItemize}
\item {\itshape \hyperlink{}{k\-A\-P\-I\-\_\-\-R\-E\-S\-P\-O\-N\-S\-E\-\_\-\-N\-O\-D\-E\-S}}\-: The list of found nodes as follows\-: 
\begin{DoxyItemize}
\item {\itshape Key}\-: The node I\-D. 
\item {\itshape Value}\-: The node properties. 
\end{DoxyItemize}
\item {\itshape \hyperlink{}{k\-A\-P\-I\-\_\-\-R\-E\-S\-P\-O\-N\-S\-E\-\_\-\-T\-E\-R\-M\-S}}\-: The list of terms related to the list of found nodes as follows\-: 
\begin{DoxyItemize}
\item {\itshape Key}\-: The \hyperlink{class_c_ontology_term}{term} global \hyperlink{}{identifier}. 
\item {\itshape Value}\-: The contents of the \hyperlink{class_c_ontology_term}{term}. 
\end{DoxyItemize}
...
protected \hypertarget{class_c_warehouse_wrapper_a5dfe94fe77e5af8a69a7361619f858d0}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Handle\-\_\-\-Get\-Relations@{\-\_\-\-Handle\-\_\-\-Get\-Relations}}
\index{\-\_\-\-Handle\-\_\-\-Get\-Relations@{\-\_\-\-Handle\-\_\-\-Get\-Relations}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Handle\-\_\-\-Get\-Relations}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Handle\-\_\-\-Get\-Relations (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_a5dfe94fe77e5af8a69a7361619f858d0}
Handle \hyperlink{}{get-\/relations} request.

This method will return the same structure as the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-G\-E\-T\-\_\-\-E\-D\-G\-E\-S} service\-:
...
protected \hypertarget{class_c_warehouse_wrapper_ab32a637787862fbfd3075290a4d18719}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Handle\-\_\-\-Get\-Scalar@{\-\_\-\-Handle\-\_\-\-Get\-Scalar}}
\index{\-\_\-\-Handle\-\_\-\-Get\-Scalar@{\-\_\-\-Handle\-\_\-\-Get\-Scalar}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Handle\-\_\-\-Get\-Scalar}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Handle\-\_\-\-Get\-Scalar (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_ab32a637787862fbfd3075290a4d18719}
Handle list scalars request.

This method will handle all requests that result in a query returning a {\itshape single} list of selected records, it is equivalent to the \hyperlink{class_c_mongo_data_wrapper_a157a45bd4a2da43bd05d62b22faf3dc6}{\-\_\-\-Handle\-\_\-\-Get} method, with the only difference being that each found element is here indexed by the object global \hyperlink{}{identifier}.
...
This method will first \hyperlink{class_c_coded_unit_object_a314fc62af62314f5ac5acca2ac809900}{load} the user by using its \hyperlink{class_c_coded_unit_object_a56af949800e65f9a283239d2e455259f}{code}, then match the \hyperlink{class_c_user_a0e6f1cf51ad23f971ed0999f8d248c8d}{password}; if they match it will return the user record.

protected \hypertarget{class_c_warehouse_wrapper_aead0b4da91699b383ec12af01bcb2d9d}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Handle\-\_\-\-Match\-Terms@{\-\_\-\-Handle\-\_\-\-Match\-Terms}}
\index{\-\_\-\-Handle\-\_\-\-Match\-Terms@{\-\_\-\-Handle\-\_\-\-Match\-Terms}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Handle\-\_\-\-Match\-Terms}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Handle\-\_\-\-Match\-Terms (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_aead0b4da91699b383ec12af01bcb2d9d}
...
protected \hypertarget{class_c_warehouse_wrapper_a0db8f3ea3a5eb7acae00766257539292}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Handle\-\_\-\-Set\-Tags@{\-\_\-\-Handle\-\_\-\-Set\-Tags}}
\index{\-\_\-\-Handle\-\_\-\-Set\-Tags@{\-\_\-\-Handle\-\_\-\-Set\-Tags}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Handle\-\_\-\-Set\-Tags}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Handle\-\_\-\-Set\-Tags (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_a0db8f3ea3a5eb7acae00766257539292}
Handle \hyperlink{}{set-\/tags} request.

This method will handle the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-S\-E\-T\-\_\-\-T\-A\-G\-S} request, which expects a list of \hyperlink{class_c_ontology_term}{term} and \hyperlink{class_c_ontology_edge}{edge} identifiers in the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-T\-\_\-\-I\-D\-E\-N\-T\-I\-F\-I\-E\-R\-S} parameter, each of those elements will either be a \hyperlink{class_c_data_type_binary}{binary} object or an array of \hyperlink{class_c_ontology_edge}{edge} identifiers.

This method will match/create data \hyperlink{class_c_ontology_tag}{tags} and return the list.
...
This method will parse the \hyperlink{}{predicates} parameter.
...
\end{DoxySeeAlso}
\hypertarget{class_c_warehouse_wrapper_ac85e601bd00d2fa1c6ac1e9954d86e27}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Parse\-Predicates\-Inclusion@{\-\_\-\-Parse\-Predicates\-Inclusion}}
\index{\-\_\-\-Parse\-Predicates\-Inclusion@{\-\_\-\-Parse\-Predicates\-Inclusion}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Parse\-Predicates\-Inclusion}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Parse\-Predicates\-Inclusion (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_ac85e601bd00d2fa1c6ac1e9954d86e27}
Parse predicates inclusion flag.

This method will parse the predicates \hyperlink{}{inclusion} parameter.

protected

\begin{DoxySeeAlso}{See Also}
k\-A\-P\-I\-\_\-\-D\-A\-T\-A\-\_\-\-R\-E\-Q\-U\-E\-S\-T k\-A\-P\-I\-\_\-\-O\-P\-T\-\_\-\-P\-R\-E\-D\-I\-C\-A\-T\-E\-S\-\_\-\-I\-N\-C 
\end{DoxySeeAlso}
...
\end{DoxySeeAlso}
\hypertarget{class_c_warehouse_wrapper_a580176717584b10567decd8a88a74eef}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Traverse@{\-\_\-\-Traverse}}
...
\item[{}]{\$the\-Level}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_a580176717584b10567decd8a88a74eef}
Traverse graph.
...
\item {\bfseries \&\$the\-Nodes}\-: Reference to the list of nodes. 
\item {\bfseries \&\$the\-Edges}\-: Reference to the list of edge elements. 
\item {\bfseries \&\$the\-Predicates}\-: Reference to the list of predicates to be considered. 
...
reference & {\em \&\$the\-Edges} & List of edge references. \\
\hline
reference & {\em \&\$the\-Predicates} & List of predicate filter references. \\
\hline
integer & {\em \$the\-Level} & Depth level.\\
\hline
\end{DoxyParams}
protected \hypertarget{class_c_warehouse_wrapper_af4e5d5995ca749eaa6f472913a27fae7}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Validate\-Identifiers@{\-\_\-\-Validate\-Identifiers}}
\index{\-\_\-\-Validate\-Identifiers@{\-\_\-\-Validate\-Identifiers}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Validate\-Identifiers}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Validate\-Identifiers (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_af4e5d5995ca749eaa6f472913a27fae7}
Validate identifier references.

We implement this method to check if all the provided identifiers correspond to existing records, if this is not the case, the method will throw an exception.

This operation will only be performed for the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-S\-E\-T\-\_\-\-T\-A\-G\-S} operation.
...
\hypertarget{class_c_warehouse_wrapper_a7256b512c0210220b30ae0c65250d748}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Validate\-Query@{\-\_\-\-Validate\-Query}}
\index{\-\_\-\-Validate\-Query@{\-\_\-\-Validate\-Query}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Validate\-Query}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Validate\-Query (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_a7256b512c0210220b30ae0c65250d748}
Validate query reference.

We overload this method for handling the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-\_\-\-M\-A\-T\-C\-H\-\_\-\-T\-E\-R\-M\-S} service.

protected 

Reimplemented from \hyperlink{class_c_mongo_data_wrapper_aa2ae2292a247d94c9b1dfa13d9a4fb85}{C\-Mongo\-Data\-Wrapper}.

\hypertarget{class_c_warehouse_wrapper_a96537df2b42833302fb52de632a8f8f4}{\index{C\-Warehouse\-Wrapper@{C\-Warehouse\-Wrapper}!\-\_\-\-Validate\-Request@{\-\_\-\-Validate\-Request}}
\index{\-\_\-\-Validate\-Request@{\-\_\-\-Validate\-Request}!CWarehouseWrapper@{C\-Warehouse\-Wrapper}}
\subsubsection[{\-\_\-\-Validate\-Request}]{\setlength{\rightskip}{0pt plus 5cm}C\-Warehouse\-Wrapper\-::\-\_\-\-Validate\-Request (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_c_warehouse_wrapper_a96537df2b42833302fb52de632a8f8f4}
Validate request.

This method should check that the request is valid and that all required parameters have been sent.

In this class we add the \hyperlink{}{k\-A\-P\-I\-\_\-\-O\-P\-T\-\_\-\-I\-D\-E\-N\-T\-I\-F\-I\-E\-R\-S} parameter validation.

protected 

Reimplemented from \hyperlink{class_c_mongo_data_wrapper_a3d06376cb588e5c26751bff3f0083ef5}{C\-Mongo\-Data\-Wrapper}.
